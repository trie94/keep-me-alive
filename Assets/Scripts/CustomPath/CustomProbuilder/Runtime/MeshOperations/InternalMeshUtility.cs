...
using System.Linq;
using ArrUtil = CustomProBuilder.ArrayUtility;
using UnityEngine;

namespace CustomProBuilder.MeshOperations
{
    static class InternalMeshUtility
    {
        ...
        public static ProBuilderMesh CreateMeshWithTransform(Transform t, bool preserveFaces)
        {
            ...
            GameObject go = (GameObject)UnityEngine.Object.Instantiate(t.gameObject);
